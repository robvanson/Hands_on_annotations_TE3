...
\begin{block}{Run a Praat script}
\begin{itemize} 
\item \texttt{Praat > Open Praat script...} Select script
\item Or: \texttt{Praat > Open > Read from file...} Select script
...
\begin{itemize} 
\item Do once what you would like to code
\item \texttt{Praat > New Praat script}
\item \texttt{Editor > Edit > Paste history}
\item Adapt script
\item \texttt{Praat > Help > Search Praat manual...}\\ \textit{Your first script}
\end{itemize}
\end{block} 
\end{frame}
